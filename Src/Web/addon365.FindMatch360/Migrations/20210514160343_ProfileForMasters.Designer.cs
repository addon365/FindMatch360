...
namespace addon365.FindMatch360.Migrations
{
    ...
    [Migration("20210514160343_ProfileForMasters")]
    partial class ProfileForMasters
    {
            ...
            modelBuilder.Entity("addon365.FindMatch360.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("ProfileMatrimonyProfileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("addon365.FindMatch360.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("addon365.FindMatch360.Models.MatrimonyProfile", "Profile")
                        .WithMany()
